 ...
 *
 */
public class l1c2 extends Activity {
    private static final String TAG = l1c2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mButtonGpio = PeripheralManager.getInstance().openGpio(pinButton);
            ...
            mButtonGpio.registerGpioCallback(new GpioCallback() {
                ...
                public boolean onGpioEdge(Gpio gpio) {
                    ...
                    // Change value INTERVAL_BETWEEN_BLINKS_MS
